    ...
    <LayoutAuthenticated>
        ...
        <SectionMain>
            ...
            <div class="flex items-center justify-end my-3 cursor-pointer">
                ...
                <Link :href="route('tags.create')" class="px-4 py-2 rounded bg-indigo-700 text-white cursor-pointer">Add
                Tag</Link>
            </div>
            ...
            <CardBox class="mb-6" has-table>
                ...
                <table>
                    ...
                    <tbody>
                        <tr v-if="props.tags.data && props.tags.data.length > 0" v-for="(tag, index) in props.tags.data"
                            :key="tag?.id || index">
                            ...
                            <td data-label="Action" class="lg:w-1 whitespace-nowrap">
                                <BaseButtons type="justify-start lg:justify-end" no-wrap>
                                    <BaseButton :href="route('tags.edit', tag?.id)" color="info" :icon="mdiEye" small
                                        @click="isModalActive = true" />
                                    <BaseButton @click="destroyTag(tag?.id)" color="danger" :icon="mdiTrashCan" small />
                                </BaseButtons>
                            </td>
                        </tr>
                        <tr v-else>
